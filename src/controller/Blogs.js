...
if(!blogPublishedDate) blogPublishedDate=moment();
...
let updatedData=await blogModel.findOneAndUpdate(
    ...
    {_id:blogId},
    {$set:{title:blogTitle,body:blogBody,tags:blogTags,subcategory:blogSubcategory,publishedAt:blogPublishedDate,isPublished:true}},
